...
public class SearchPageObject extends MainPageObject
{
    ...
    SEARCH_PLACEHOLDER = "org.wikipedia:id/search_container";
   ...
   /*TEMPLATES METHODS*/
    ...
    {
        this.assertNotElementForPresent(By.xpath(SEARCH_RESULT_ELEMENT),
                "We supposed not to find any results");
    }

    public void waitForSearchPlaceholder()
    {
