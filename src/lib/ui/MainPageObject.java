...
public class MainPageObject {
    ...
    public WebElement waitForElementAndClean(By by, String error_messagge, long timeOutSeconds) {
    ...
    public String assertElementHasText(By by, String text, String error_message, long timeoutInSeconds) {
    ...
    public void assertNotElementForPresent (By by, String error_message)
    {
